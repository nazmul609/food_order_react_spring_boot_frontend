    ...
    <div className="w-full min-h-screen bg-green-50 overflow-x-hidden">
      <div className="max-w-screen-xl mx-auto px-4 py-12">
        <div className="flex flex-col md:flex-row">
          {/* Filters Section */}
          <div className="w-full md:w-1/5 md:pr-8 mb-6 md:mb-0 relative -ml-6 md:-ml-8">
            <div className="bg-white p-6 rounded-lg shadow-lg">
              ...
              <div className="flex flex-wrap gap-4 mb-6">
                <select
                  ...
                  className="block w-full rounded bg-gray-50 px-4 py-3 text-sm font-medium text-gray-700 shadow focus:outline-none focus:ring"
                >
                ...
                <label className="w-full flex items-center rounded bg-gray-50 px-4 py-3 text-sm font-medium text-gray-700 shadow focus:outline-none focus:ring">
                  <input
                    type="checkbox"
                    name="offers"
          ...
          <div className="w-full md:w-4/5 md:pl-8">
            <div className="mb-6">
              <input
                ...
                className="w-full rounded bg-gray-50 px-4 py-3 text-sm font-medium text-gray-700 shadow focus:outline-none focus:ring"
                value={searchTerm}
